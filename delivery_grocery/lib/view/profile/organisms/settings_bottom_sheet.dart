        ...
        child: ListView(
          ...
          children: [
            Padding(
              ...
              child: Column(
                children: [
                  const TitleAndIcon(title: AppStrings.profileSettings),
                  24.verticalSpace,
                  Row(
                    children: [
                      Stack(
                        ...
                        children: [
                          ShopAvatar(
                            radius: 16,
                            imageUrl:
                                _myProfileModel.imgUrl, //profileModel?.imgUrl,
                            // path: imageState.path,
                            size: 50,
                            padding: 6,
                            bgColor: AppColors.blackColor.withOpacity(0.27),
                          ),
                          Container(
                            width: 50,
                            height: 50,
                            decoration: BoxDecoration(
                              ...
                              color: AppColors.blackColor.withOpacity(0.27),
                            ),
                          ),
                          IconButton(
                            icon: const Icon(
                      ...
                      Expanded(
                        child: UnderlinedBorderTextFieldMolecule(
                          ...
                          onChanged: (val) {},
                          descriptionText:
                              //_myProfileModel.isFirstnameError
                              "",
                          isError: false, //_myProfileModel.isFirstnameError,
                        ),
                      ),
                    ],
                  ),
